...
import { getCompanyId, metadataToObject, refToObject } from '../../quickbooks/helpers/quickbooks.js';
import type { QuickBooksMetadata, QuickBooksRef } from '../../quickbooks/helpers/quickbooks.js';
import { isoDateSchema, metadataSchema, refSchema } from '../../quickbooks/helpers/schemas.js';
...
type CreateJournalEntryInput = z.infer<typeof inputSchema>;
...
function toOutput(entry: QuickBooksJournalEntry): z.infer<typeof outputSchema> {
